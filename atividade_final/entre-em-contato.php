    ...
    <main role="main">
        <section class="container">
            <form action="processadados.php" id="formulario" method="POST">
              ...
              <div>
                <label for="mensagem">Por email:</label>
                <input type="text" id="mensagem" placeholder="Digite seu email" autofocus/>
              </div>
              <div>
                <label for="mensagem2">Nome</label>
                <input type="text" id="mensagem2" placeholder="Digite seu nome" />
              </div>
              <div>
