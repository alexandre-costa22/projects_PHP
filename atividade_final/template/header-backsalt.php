<header id="header">
        <div id="div-cabecalho">
            ...
            <!-- Auth Status -->
            <div class="div-auth-status">
                <a href="../login.php" id="button-login-auth-status" class="button-auth-status">Entrar</a>
                <a class="button-auth-status">|</a>
                <a href="../register.php" id="button-register-auth-status" class="button-auth-status">Cadastrar</a>
            </div>
            <!-- Social Media HERE -->
            <nav id="social-midia">
